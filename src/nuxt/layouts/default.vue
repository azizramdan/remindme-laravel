      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div :class="{'md:hidden': !useAuthStore().isAuthenticated}" class="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <NuxtLink to="/reminders" active-class="md:bg-nabitu-100 dark:md:bg-nabitu-900" class="block py-2 px-3 rounded md:bg-transparent md:text-nabitu-700 md:p-2 hover:bg-nabitu-100 dark:hover:bg-nabitu-900 dark:text-white md:dark:text-nabitu-500" aria-current="page">Reminder</NuxtLink>
            </li>
            <li>
              <button @click="logout" active-class="md:bg-nabitu-100 dark:md:bg-nabitu-900" class="w-full text-left py-2 px-3 rounded md:bg-transparent md:text-nabitu-700 md:p-2 hover:bg-nabitu-100 dark:hover:bg-nabitu-900 dark:text-white md:dark:text-nabitu-500">Logout</button>
            </li>
          </ul>
        </div>
      </div>
